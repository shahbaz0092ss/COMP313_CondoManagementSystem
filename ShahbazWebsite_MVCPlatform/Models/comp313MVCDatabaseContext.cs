...

{
    public partial class comp313MVCDatabaseContext : DbContext
    {
        ...
        // ** Removing inline context condifguration (generated by default by scafollding) **
        ...
        // ** Adding constructor, which will allow configuration to be passed into the context by dependency injection **
        // Context will be registered in Startup.cs, to be used by web app.

        public comp313MVCDatabaseContext(DbContextOptions<comp313MVCDatabaseContext> options)
        : base(options)
         { }
